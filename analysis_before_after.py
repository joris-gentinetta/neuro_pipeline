...
level_1 = ['characteristics' for _ in range(10)] \
...
for experiment_name in experiment_names:
    ...
    if do_archive:
        if environment == 'EZM':
            ...
            archive.loc['characteristics']['ezm_closed'], archive.loc['characteristics']['ezm_transition'] = plots.get_ezm_score(archive.loc['ROI_EZM'])
        elif environment == 'OFT':
            archive.loc['characteristics']['of_corners_score'], archive.loc['characteristics']['of_middle_score'],\
            archive.loc['characteristics']['of_corners'], archive.loc['characteristics']['of_middle'] = plots.get_of_score(archive.loc['ROI_OF'])
pass
